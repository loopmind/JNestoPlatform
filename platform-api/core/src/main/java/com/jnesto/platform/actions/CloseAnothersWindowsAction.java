 ...
 */
@ServiceProvider(
        id = "#CTL_CLOSEANOTHERWINDOWSACTION",
...
@Extension
public class CloseAnothersWindowsAction extends AbstractAction implements JMenuItemAction, JToolBarAction, ExtensionPoint {

    public CloseAnothersWindowsAction() {
        super();
        init();
    }

    private void init() {
        putValue(AbstractAction.NAME, "Fecha Outros Documentos");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        DockingManager.getDockableIds().forEach(id -> {
            ...
            if (dock != null && dock instanceof View && !((View) dock).isActive()) {

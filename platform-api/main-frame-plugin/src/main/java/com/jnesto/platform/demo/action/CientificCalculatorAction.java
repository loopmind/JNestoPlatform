 ...
 */
@ServiceProvider(
        id = "#CTL_CIENTIFICCALCULATORACTION",
...
public class CientificCalculatorAction extends AbstractAction implements JMenuItemAction, JToolBarAction, ExtensionPoint {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Object bellAction = Lookup.lookupById("#CTL_BELLACTION");
        if(bellAction != null && bellAction instanceof Action) {
            ((Action) bellAction).setEnabled(!((Action) bellAction).isEnabled());
        }
    }

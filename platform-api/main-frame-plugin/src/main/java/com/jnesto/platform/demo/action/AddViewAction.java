 ...
 */
@ServiceProvider(
        id = "#CTL_ADDVIEWACTION",
        service = {JMenuAction.class}
)
@Extension
public class AddViewAction extends AbstractAction implements JMenuItemAction, JToolBarAction, ExtensionPoint {
    ...
    private void init() {
        try {
            putValue(AbstractAction.NAME, "Novo");
            putValue(AbstractAction.SMALL_ICON, new ImageIcon(ImageIO.read(getClass().getResourceAsStream("/resources/icons/add.png"))));

 ...
 */
@ServiceProvider(
        id = "junit.action.FileExitAction",
...
@Extension
public class FileExitAction extends AbstractAction implements JMenuItemAction, ExtensionPoint {
    ...
    private void init() {
        ...
        try {
            ...
            LoggerFactory.getLogger(FileExitAction.class).trace(ex.getLocalizedMessage(), ex);
        }
    }
